package com.tutorial.numeric_dan_character;

public class NumericAndCharacterTest {
     ...
     * ● Namun walaupun data sebenarnya harus menggunakan tipe data byte, namun karena secara default saat kita membuat number di Java selalu menggunakan tipe data int, maka hampir
     *   kebanyakan return value dan parameter di IO Stream di Java menggunakan tipe data int
